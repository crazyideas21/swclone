...
const char *ovsrec_bridge_get_external_ids_value(const struct ovsrec_bridge *, const char *key, const char *default_value);
const char *ovsrec_bridge_get_other_config_value(const struct ovsrec_bridge *, const char *key, const char *default_value);
const char *ovsrec_bridge_get_status_value(const struct ovsrec_bridge *, const char *key, const char *default_value);

/* Controller table. */
...
void ovsrec_controller_set_other_config(const struct ovsrec_controller *, char **key_other_config, char **value_other_config, size_t n_other_config);
...
const char *ovsrec_controller_get_external_ids_value(const struct ovsrec_controller *, const char *key, const char *default_value);
const char *ovsrec_controller_get_other_config_value(const struct ovsrec_controller *, const char *key, const char *default_value);
const char *ovsrec_controller_get_status_value(const struct ovsrec_controller *, const char *key, const char *default_value);

/* Flow_Table table. */
...
const char *ovsrec_interface_get_external_ids_value(const struct ovsrec_interface *, const char *key, const char *default_value);
const char *ovsrec_interface_get_options_value(const struct ovsrec_interface *, const char *key, const char *default_value);
const char *ovsrec_interface_get_other_config_value(const struct ovsrec_interface *, const char *key, const char *default_value);
const char *ovsrec_interface_get_status_value(const struct ovsrec_interface *, const char *key, const char *default_value);

/* Manager table. */
...
void ovsrec_manager_set_other_config(const struct ovsrec_manager *, char **key_other_config, char **value_other_config, size_t n_other_config);
...
const char *ovsrec_manager_get_external_ids_value(const struct ovsrec_manager *, const char *key, const char *default_value);
const char *ovsrec_manager_get_other_config_value(const struct ovsrec_manager *, const char *key, const char *default_value);
const char *ovsrec_manager_get_status_value(const struct ovsrec_manager *, const char *key, const char *default_value);

/* Mirror table. */
...
const char *ovsrec_mirror_get_external_ids_value(const struct ovsrec_mirror *, const char *key, const char *default_value);

/* NetFlow table. */
...
const char *ovsrec_netflow_get_external_ids_value(const struct ovsrec_netflow *, const char *key, const char *default_value);

/* Open_vSwitch table. */
...
void ovsrec_open_vswitch_set_other_config(const struct ovsrec_open_vswitch *, char **key_other_config, char **value_other_config, size_t n_other_config);
...
const char *ovsrec_open_vswitch_get_external_ids_value(const struct ovsrec_open_vswitch *, const char *key, const char *default_value);
const char *ovsrec_open_vswitch_get_other_config_value(const struct ovsrec_open_vswitch *, const char *key, const char *default_value);
const char *ovsrec_open_vswitch_get_statistics_value(const struct ovsrec_open_vswitch *, const char *key, const char *default_value);

/* Port table. */
struct ovsrec_port {
	struct ovsdb_idl_row header_;
...
const char *ovsrec_port_get_external_ids_value(const struct ovsrec_port *, const char *key, const char *default_value);
const char *ovsrec_port_get_other_config_value(const struct ovsrec_port *, const char *key, const char *default_value);
const char *ovsrec_port_get_status_value(const struct ovsrec_port *, const char *key, const char *default_value);

/* QoS table. */
struct ovsrec_qos {
	struct ovsdb_idl_row header_;
...
const char *ovsrec_qos_get_external_ids_value(const struct ovsrec_qos *, const char *key, const char *default_value);
const char *ovsrec_qos_get_other_config_value(const struct ovsrec_qos *, const char *key, const char *default_value);

/* Queue table. */
struct ovsrec_queue {
	struct ovsdb_idl_row header_;
...
const char *ovsrec_queue_get_external_ids_value(const struct ovsrec_queue *, const char *key, const char *default_value);
const char *ovsrec_queue_get_other_config_value(const struct ovsrec_queue *, const char *key, const char *default_value);

/* SSL table. */
struct ovsrec_ssl {
	struct ovsdb_idl_row header_;
...
const char *ovsrec_ssl_get_external_ids_value(const struct ovsrec_ssl *, const char *key, const char *default_value);

/* sFlow table. */
struct ovsrec_sflow {
	struct ovsdb_idl_row header_;
...
const char *ovsrec_sflow_get_external_ids_value(const struct ovsrec_sflow *, const char *key, const char *default_value);
