...
class HPSwitch:
    ...
    def __init__(self):
        ...
        self.source_ip = '10.66.10.1'
        self.dest_ip = '10.66.8.1'
        
        self.source_mac = '00:19:b9:f9:2d:e2'
        self.dest_mac = '00:19:b9:f8:ea:f8'
        
        # OpenFlow ports to which each machine is connected.
        self.source_of_port = '34'
        self.dest_of_port = '32'
        ...
        # Control IP
        self.pktgen_host = '172.22.14.208'
        ...
        self.source_ip_fake = '10.66.10.20'
        ...
        self.ofctl_ip = '172.19.222.80' # This is our NAT box.
        
        # How can we connect to the switch
        self.sw_connection = 'tcp:192.168.1.201:12201'
        
        self.del_flow_cmd = '~/openflow.cd/dpctl del-flows ' + self.sw_connection + ' && echo del-flows OK'
        
        self.dump_flows_cmd = '~/openflow.cd/dpctl dump-flows ' + self.sw_connection
        
        self.add_rule_cmd = lambda rule: '~/openflow.cd/dpctl add-flow ' + self.sw_connection + ' \'' + rule + '\''
